...
namespace VRTK
{
    ...
    public class VRTK_InteractableObject : MonoBehaviour
    {
        ...
        public UnityEvent onMeshEnter = new UnityEvent();
        public UnityEvent onMeshExit = new UnityEvent();
        public UnityEvent grabedEnter = new UnityEvent();
        public UnityEvent grabedExit = new UnityEvent();
